...
class TestCreateAndExtend(TestCase):
    ...
    def test_check_schema_with_different_metaschema(self):
        ...
        NoEmptySchemasValidator = validators.create(
            meta_schema={
                "$schema": validators.Draft4Validator.META_SCHEMA["id"],
                "type": "object",
                "required": ["foo",],
            },
        )
...
class TestValidationErrorDetails(TestCase):
    ...
    def test_multiple_nesting(self):
        ...
        self.assertEqual(e4.path, deque([1, "bar"]))
        ...
        self.assertEqual(e4.json_path, "$[1].bar")
        ...
        self.assertEqual(
            list(e3.schema_path), ["items", "properties", "bar", "required"],
        )
        self.assertEqual(
            list(e4.schema_path),
        ...
        self.assertEqual(e2.validator, "type")
        self.assertEqual(e3.validator, "required")
        self.assertEqual(e4.validator, "type")
    ...
    def test_boolean_schema_False(self):
        validator = validators.Draft4Validator(False)
...
class TestRefResolver(TestCase):
    ...
    def test_it_does_not_retrieve_schema_urls_from_the_network(self):
        ref = validators.Draft4Validator.META_SCHEMA["id"]
        with mock.patch.object(self.resolver, "resolve_remote") as patched:
            with self.resolver.resolving(ref) as resolved:
                pass
        self.assertEqual(resolved, validators.Draft4Validator.META_SCHEMA)
