...
class ObjectWithInfoSupport3:
    ...
    def __asdf_traverse__(self):
        return {"attributeOne": self.attribute_one, "attributeTwo": self.attribute_two}
...
"""
    ...
    class BarConverter:
        ...
        def to_yaml_tree(self, obj, tag, ctx):
            return {"attribute1": obj.attribute1, "attribute2": obj.attribute2}
    ...
    class DrinkConverter:
        ...
        def to_yaml_tree(self, obj, tag, ctx):
            return {"attributeOne": obj.attribute_one, "attributeTwo": obj.attribute_two}
