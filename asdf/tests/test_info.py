...
class ObjectWithInfoSupport:
    def __init__(self, clown='', the_meaning=0, anyof=None, allof=None,
                 oneof=None, **kw):
    ...
    def __asdf_traverse__(self):
        returnval = {'the_meaning_of_life_the_universe_and_everything':
                     self.the_meaning_of_life_the_universe_and_everything,
                     'clown': self.clown
                     }
...
class ObjectWithInfoSupport2:
    ...
    def __asdf_traverse__(self):
        returnval = {'attribute1': self.attribute1,
...
"""
    ...
    config.add_resource_mapping(
        DirectoryResourceMapping(str(tmpdir / "schemas"), "asdf://somewhere.org/asdf/schemas/")
        )
    ...
    class FooConverter:
        ...
        def to_yaml_tree(self, obj, tag, ctx):
            node = {'the_meaning_of_life_the_universe_and_everything':
                    obj.the_meaning_of_life_the_universe_and_everything,
                    'clown': obj.clown}
        ...
        def from_yaml_tree(self, node, tag, ctx):
            return ObjectWithInfoSupport(the_meaning=
                node['the_meaning_of_life_the_universe_and_everything'],
                clown=node['clown'])
    ...
    class BarConverter:
        ...
        def to_yaml_tree(self, obj, tag, ctx):
            node = {'attribute1': obj.attribute1,
                    'attribute2': obj.attribute2}
            return node

        def from_yaml_tree(self, node, tag, ctx):
            return ObjectWithInfoSupport(attribute1='value1',
                                         attribute2='value2')
...
def test_info_object_support(capsys):
    ...
    af.tree = {
        ...
        'object': ObjectWithInfoSupport(
            'Bozo', 42, anyof=ObjectWithInfoSupport2('VAL1', 'VAL2'), oneof=20,
            allof='good', S_example="beep", I_example=1)
        }
