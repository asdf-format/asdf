...
def test_defaults():
    ...
    validator = schema._create_validator(schema.FILL_DEFAULTS)(s, **schema._make_jsonschema_resolver_or_registry(None))
    ...
    validator = schema._create_validator(schema.REMOVE_DEFAULTS)(
        s,
        **schema._make_jsonschema_resolver_or_registry(None),
    )
    validator.validate(t)
